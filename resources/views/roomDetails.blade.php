                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6 col-md-3 col-lg-3">
                            <div class="product-detail_item">
                                <div class="img">
                                    <a href="#"><img src="{{ asset('images/Product/Another-.jpg') }}"
                                            alt="#"></a>
                                </div>
                                <div class="text">
                                    ...
                                    <ul>
                                        ...
                                        <li><i class="fa fa-bed" aria-hidden="true"></i> Bed: King-size or twin beds
                                        </li>
                        ...
                        <div class="col-sm-6 col-md-3 col-lg-3">
                            <div class="product-detail_item">
                                <div class="img">
                                    <a href="#"><img src="{{ asset('images/Product/Another-1.jpg') }}"
                                            alt="#"></a>
                                </div>
                                <div class="text">
                        ...
                        <div class="col-sm-6 col-md-3 col-lg-3">
                            <div class="product-detail_item">
                                <div class="img">
                                    <a href="#"><img src="{{ asset('images/Product/Another-3.jpg') }}"
                                            alt="#"></a>
                                </div>
                                <div class="text">
                        ...
                        <div class="col-sm-6 col-md-3 col-lg-3">
                            <div class="product-detail_item">
                                <div class="img">
                                    <a href="#"><img src="{{ asset('images/Product/Another-4.jpg') }}"
                                            alt="#"></a>
                                </div>
                                <div class="text">
